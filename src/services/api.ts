...
const API_BASE_URL = isDev ? '/api/v1' : 'http://124.123.3.225:9000/api/v1';

const BOARD_API_BASE_URL = isDev ? '/board-api/v1' : 'http://124.123.3.225:9000/api/v1';

const UMPIRE_API_BASE_URL = isDev ? '/umpire-api/v1' : 'http://124.123.3.225:9000/api/v1';

const SCORING_API_BASE_URL = isDev ? '/scoring-api/v1' : 'http://124.123.3.225:9000/api/v1';
